...
const alseus = {
    ...
    education: [
        ...
        "BS Electronics Engineering — University of Southeastern Philippines"
    ],
    certification: "NVIDIA Deep Learning Institute",
    currentFocus: ["AI/ML Applications", "RAG Architecture", "Full Stack Development"],
    funFact: "I went from building hospital systems to building AI — still debugging human errors either way."
};
```
...
`LLM` `RAG Architecture` `Chainlit` `Open WebUI` `H2O.ai` `ChromaDB` `Weaviate`
...
## <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Chart%20Increasing.png" alt="Activity" width="28" /> &nbsp;Contribution Graph
